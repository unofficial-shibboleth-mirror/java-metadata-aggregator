...
public class RemoveOrganizationStage extends AbstractComponent implements Stage<DomMetadata> {

    /** Class logger. */
    private final Logger log = LoggerFactory.getLogger(RemoveContactPersonStage.class);

    /**
     * Filters out any Organization elements found within EntityDescriptors.
     * 
