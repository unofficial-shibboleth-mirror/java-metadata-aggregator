...
/**
 * A component of a {@link net.shibboleth.metadata.pipeline.Pipeline} which produces the input
 * to the pipeline.
 * 
...
public interface Source<ElementType extends Metadata<?>> extends Component {
    ...
    /**
     * Produces the input to the {@link net.shibboleth.metadata.pipeline.Pipeline}.
     * 
