...
/**
 * A {@link SelectCondition} whose result is the boolean OR its operands. If no conditions are given the result
 * of this condition is false.
 */
@ThreadSafe
public class OrSelectCondition implements SelectCondition<MetadataElement<?>> {

    /** {@link SelectCondition} operands which are OR'ed. */
    private SelectCondition<MetadataElement<?>>[] operandConditions;
    
    /**
     * Constructor.
     * 
     * @param conditions conditions which will be OR'ed together
     */
    public OrSelectCondition(SelectCondition<MetadataElement<?>>... conditions){
